...
/**
 * Validator for owner-related operations, ensuring that all horse data meets the required constraints.
 */
@Component
public class OwnerValidator {
  ...
  /**
   * Constructs a new {@code OwnerValidator} with the specified data access dependency.
   *
   * @param dao the {@link OwnerDao} used to access owner-related data for performing validation checks.
   */
